...
while 1:
 ...
 /   _____/  _____    ______\______   \  ____    _____ \_ |__    ____ _______  
 \_____  \  /     \  /  ___/ |    |  _/ /  _ \  /     \ | __ \ _/ __ \\_  __ \ 
 /        \|  Y Y  \ \___ \  |    |   \(  <_> )|  Y Y  \| \_\ \\  ___/ |  | \/ 
/_______  /|__|_|  //____  > |______  / \____/ |__|_|  /|___  / \___  >|__|    
        \/       \/      \/         \/               \/     \/      \/         
    ...
    if menu == 1:
        ...
        if tel_no == "":
            system("cls||clear")
        if tel_no == "5393423919":
            system("cls||clear")
            print(Fore.RED + "Beni Bomblayabileceğini Mi Sandın?")
            time.sleep(3)
            system("cls||clear")
            print(Fore.RED + "Yazık Kafana")
            time.sleep(3)
            quit()
        if tel_no == "5511930529":
            system("cls||clear")
            print(Fore.RED + "A sende mi rick and morty fanısın?")
            time.sleep(3)
            system("cls||clear")
            print(Fore.RED + "siktir git burdan")
            time.sleep(3)
            quit()
        if tel_no == "5423379773":
            system("cls||clear")
            print(Fore.RED + "Mithat'ı Bomblayabileceğini Mi Sandın?")
            time.sleep(3)
            system("cls||clear")
            print(Fore.RED + "Yazık Kafana")
            time.sleep(3)
            quit()
        if tel_no == "5050587404":
            system("cls||clear")
            print(Fore.RED + "Berenimi Birtek Ben Sinir Edebilirim <3")
            time.sleep(3)
            system("cls||clear")
            print(Fore.RED + "Şimdi Uza")
            time.sleep(3)
            quit()
        ...
        system("cls||clear")
        print(Fore.LIGHTWHITE_EX + " ERROR\n ERROR")
        sleep(12)
    elif menu == 4:
        system("cls||clear")
